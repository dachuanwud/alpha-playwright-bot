...
class TradeStats:
    ...
    def print_summary(self):
        ...
        print("╠══════════════════════════════════════════════════╣")
        print(f"║  初始余额:       {self.start_balance:>10.2f}                  ║")
        print(f"║  最终余额:       {self.end_balance:>10.2f}                  ║")
        print(f"║  余额变化:       {self.profit:>+10.2f}                  ║")
        print(f"║  💰 消耗成本:    {self.total_fee_consumed:>10.2f}                  ║")
        if self.successful_buys > 0:
            avg_cost = self.total_fee_consumed / self.successful_buys
            print(f"║  单笔平均消耗:   {avg_cost:>10.4f}                  ║")
        print("╠══════════════════════════════════════════════════╣")
